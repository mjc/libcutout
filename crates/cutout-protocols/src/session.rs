...
use cutout_core::{
    ...
    DeviceCommand, DeviceEvent, GattChannel, GattFingerprint, GattRoles, Measured,
    ModelRegistryEntry, MonotonicTimestamp, NotificationByteLen, NotificationIngestOutcome,
    ParserDiagnostics, ParserError, ParserGapEvidence, PayloadBodyLen, PayloadClassifier,
    ProtocolFamily, ProtocolSelector, ProtocolSession, Quantity, ReadOnlyResponse,
    ReservedPayloadEvidence, SafetyClass, SemanticEventCount, SeriesCount, SessionInput,
    SessionOutput, SessionOutputError, SessionOutputSink, Temperature, TransportAction, Unit,
    VerificationStatus, VerifiedValue, Voltage, WritePayload,
};

use crate::{
    AeroProbe, AeroRequestEncoder, RequestDisposition, VETERAN_DATA_CHANNEL,
...
mod tests {
    ...
    use super::*;
    use crate::{
        BEGODE_DATA_CHANNEL, BegodeFalconModel, BegodeNotificationDecoder,
        BegodePackVoltageProfile, GearRatioDenominator, MotorPolePairs, RequestDisposition,
        VESC_NOTIFY_CHANNEL, VESC_RAW_CONTROLLER_ID_FIELD_ID, VESC_RAW_ERPM_FIELD_ID,
        ...
        VescBoardProfile, VescGenericModel, VescNotificationDecoder,
