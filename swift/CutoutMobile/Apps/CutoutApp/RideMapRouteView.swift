...
struct RideMapRouteView: View {
    ...
    private var liveContent: some View {
        RideMapLiveContentView(
            displayPoints: model.rideRecording.displayPoints,
            routeID: "live",
            projectionVersion: model.rideRecording.projectionVersion,
            endpointMetadata: model.rideRecording.endpointMetadata,
            cameraRegion: model.rideRecording.cameraRegion,
            segments: model.rideRecording.segments,
            snapshot: model.rideRecording.snapshot,
            isCommandPending: model.rideRecording.isCommandPending,
            availability: model.rideMapAvailability,
            speed: model.speed,
            vehicleName: model.rideMapVehicleName,
            mapError: model.rideRecording.error,
            lastDecision: model.rideRecording.lastDecision,
            telemetryState: model.rideRecording.telemetryState,
            pointsTruncated: model.rideRecording.pointsTruncated,
            segmentsOmittedByBudget: model.rideRecording.segmentsOmittedByBudget,
            canonicalBackgroundGapCount: model.rideRecording.backgroundGapCount,
