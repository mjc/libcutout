    ...
    var body: some View {
        HStack(alignment: .center, spacing: 8) {
            VStack(spacing: 4) {
                ...
                RideActivityGlyph(snapshot: snapshot)
...
private struct MetricGrid: View {
    ...
    var body: some View {
        Grid(horizontalSpacing: 0, verticalSpacing: 0) {
            GridRow {
                metricCell(value: snapshot.battery, tint: RideActivityPalette.connected, showProgress: true)
                metricCell(value: snapshot.packVoltage, tint: RideActivityPalette.primaryText)
                metricCell(value: snapshot.pwm, tint: RideActivityPalette.accent2, showProgress: true)
            }
            GridRow {
                metricCell(value: snapshot.mode, tint: RideActivityPalette.orange)
                metricCell(value: snapshot.duration, tint: RideActivityPalette.primaryText)
                metricCell(value: snapshot.distance, tint: RideActivityPalette.primaryText)
            }
        }
    ...
    private func metricCell(
        ...
        PevLiveActivityValueCell(
            value: value,
            tint: tint,
            textColor: RideActivityPalette.primaryText,
            secondaryTextColor: RideActivityPalette.secondaryText,
    ...
    var body: some View {
        HStack(spacing: compact ? 6 : 8) {
            FooterChip(
                ...
                tint: headroomIsWarning ? RideActivityPalette.warning : RideActivityPalette.connected
            )
...
private struct RideActivityGlyph: View {
    let snapshot: LiveActivityRideSnapshot
