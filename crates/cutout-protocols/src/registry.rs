...
pub const BEGODE_FALCON_REGISTRY_ENTRY: ModelRegistryEntry = ModelRegistryEntry {
    ...
    battery: Some(BatterySpec {
        series_cells: BegodePackVoltageProfile::Falcon84VFullCharge.series_cells(),
        nominal_capacity_mah: BegodePackVoltageProfile::Falcon84VFullCharge.nominal_capacity_mah(),
...
mod tests {
    ...
    #[test]
    fn begode_falcon_registry_entry_records_84v_full_charge_battery_profile() {
