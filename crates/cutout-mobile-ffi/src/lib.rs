...
use cutout_core::{
    ...
    CommandKindDto, ControlRefusalReasonDto, CutoutSessionState, DeviceCommandDto,
...
use cutout_protocols::{
    ...
    DeviceDetectionSession, DeviceFamily, IdentityBannerEvidence, NovatekCommandOutcome,
    NovatekHttpOrigin, NovatekMediaPathError, NovatekOriginError, NovatekReadCommand,
    NovatekRecordingCommand, NovatekStillCaptureCommand, NovatekStoragePresence, PendingProbe,
    ...
    RetinaVideoFrame, StagedIdentityInput, StagedIdentityOutcome, VETERAN_FIELD_PEDALS_MODE,
    ...
    identify_known_model, is_r3_pro_firmware, new_nosfet_aero_read_only_session,
    parse_read_only_snapshot, try_new_begode_falcon_read_only_session,
};
...
pub enum MobileCameraPreviewError {
    ...
    OriginMismatch,
    /// The RTSP server advertised no video stream.
...
impl From<RetinaRtspError> for MobileCameraPreviewError {
    fn from(error: RetinaRtspError) -> Self {
        match error {
            ...
            RetinaRtspError::NoVideoStream => Self::NoVideoStream,
