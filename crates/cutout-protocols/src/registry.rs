...
pub const BEGODE_FALCON_REGISTRY_ENTRY: ModelRegistryEntry = ModelRegistryEntry {
    ...
    battery: Some(BatterySpec {
        series_cells: BegodePackVoltageProfile::Falcon84VNominal.series_cells(),
        nominal_capacity_mah: BegodePackVoltageProfile::Falcon84VNominal.nominal_capacity_mah(),
...
mod tests {
    ...
    #[test]
    fn begode_falcon_registry_entry_records_84v_nominal_battery_profile() {
