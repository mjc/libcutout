...
use crate::{
    ...
    RequestDisposition, VETERAN_DATA_CHANNEL, VETERAN_SERVICE_CHANNEL, VeteranBmsCellPage,
...
mod tests {
    ...
    use super::*;
    use crate::{
        GearRatioDenominator, MotorPolePairs, VESC_NOTIFY_CHANNEL, VESC_RAW_CONTROLLER_ID_FIELD_ID,
