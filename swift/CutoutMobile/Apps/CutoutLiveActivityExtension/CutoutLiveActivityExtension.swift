                        ...
                        ViewThatFits(in: .horizontal) {
                            HStack(spacing: 5) {
                                if context.presentationSnapshot.connectionState != .connected {
                                    Text(
                                        context.presentationSnapshot.connectionState.accessibilityValue
                                ...
                                Circle()
                                    .fill(
                                        context.presentationSnapshot.connectionState == .connected
    ...
    extension ActivityViewContext where Attributes == LiveActivityRideAttributes {
        fileprivate var presentationSnapshot: LiveActivityRideSnapshot {
