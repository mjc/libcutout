use cutout_core::{
    AeroAngleAdjustment, AeroPwmPercent, AeroSpeedSetting, DeviceCommand, DeviceEvent, Duration,
    ...
    SessionOutput, SettingsEntry, SettingsReadback, Speed, StationarySettingsPolicy,
...
impl AeroSettingsSimulator {
    ...
    fn is_delayed_sequence(&self, command: DeviceCommand) -> bool {
